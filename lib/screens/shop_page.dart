...
class _ShopPageState extends State<ShopPage> with CartProvier {
                            ...
                            child: Container(
                              ...
                              child: IconButton(
                                onPressed: () {
                                  ...
                                  bool isExist =
                                      searchCart.isExistInCart(items[index]);
                                  ...
                                  if (isExist) {
                                    searchCart.updateCountNum(
                                        items[index], count);
                                  } else {
                                    searchCart.addCart(items[index], count);
                                  }
